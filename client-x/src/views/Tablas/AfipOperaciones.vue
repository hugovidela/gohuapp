      ...
      <v-data-table
        ...
        <template v-slot:top>
          <v-toolbar flat :color="colorSucursal">
            ...
            <v-toolbar-title class="body-1 white--text">Tipos de Operaciones AFIP</v-toolbar-title>
...
export default {
  ...
  data: () => ({
    ...
    headers: [
      ...
      { text: 'COMPRA', value:'compras'},
      { text: 'VENTA', value:'ventas'},
  ...
  computed: {
    ...
    formTitle () {
      return this.editedIndex === -1 ? 'Nueva Operacion' : 'Editar Operacion';
    },
  },
  watch: {
    dialog (val) {
 ...
 methods: {
   ...
   closeForm(){
    ...
    guardar() {
      ...
      this.compra = this.editado.compra;
      this.venta = this.editado.venta;
