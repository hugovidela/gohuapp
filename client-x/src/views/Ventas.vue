...
//          this.lisItems.push(data[0].listas[i].nombre)
      ...
      if (que === 'fac') {
        ...
        this.formTitle = 'Nueva Nota de Débito'
      } else if (que === 'rem') {
    ...
    altaHTTP:function() {
      ...
      return HTTP().post('/ventas', {
        ...
        importedescuento: this.editado.importedescuento,
        gravado: this.editado.gravado,
        exento: this.editado.exento,
        iva: this.editado.iva,
        total: this.editado.total,
        regstk: true,
        estado: 'F',
        activo: true,
    ...
    guardar() {
      ...
      if (Number(this.valCtaCte) !== 0) {
        ...
        this.pendientes.push({ 
          ...
          importe: this.valCtaCte,
          pendiente: this.valCtaCte,
